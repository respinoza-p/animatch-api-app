...
const relacionOtrosAnimales = require("./relacionOtrosAnimales");
const registroAnimal = require("./registroAnimal");
...
const registroAdoptante = require("./registroAdoptante");
...
const compromisosAdoptante = require("./compromisosAdoptante");
const contactoConRescatistas = require("./contactoConRescatistas");
...
router.use("/relacionOtrosAnimales", relacionOtrosAnimales);
router.use("/registroAnimal", registroAnimal);
...
router.use("/humano/registroAdoptante",registroAdoptante);
...
router.use("/adopcion/compromisosAdoptante", compromisosAdoptante);
router.use("/adopcion/contactoConRescatistas", contactoConRescatistas);
